...
системных вызовов open(), write(), close() для записи информации в файл*/
#include <sys/types.h>
#include <fcntl.h>
#include <stdio.h>
#include <stdlib.h>
...
umask(0);
/* Пытаемся открыть файл с именем myfile в текущей 
директории только для операций вывода. Если файла
не существует, попробуем его создать с првами доступа
0666, т.е. read-write для всех категорий пользователей */
